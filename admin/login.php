...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $sql = "SELECT u.id, u.tendangnhap, u.password, r.quyen 
            FROM user u
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            if ($user['quyen'] === 'admin') {
                ...
                header('Location: login.php?message=not_admin');
                exit();
            }
        } else {
...
<body>
    ...
    <div class="login-container">
        ...
        <form id="loginForm" method="post">
            ...
            <div class="form-group">
                <a href="/admin/register.php" class="register-link">Bạn chưa có tài khoản? Đăng ký</a>
            </div>
        </form>
    </div>
